...
![](PA1_template_files/figure-latex/barplot-1.pdf)<!-- --> 
...
```
Mean and median of the total number of steps taken per day are \ensuremath{1.076619\times 10^{4}} steps and 10765 steps, respectively.
...
![](PA1_template_files/figure-latex/daily-1.pdf)<!-- --> 
...
![](PA1_template_files/figure-latex/histogram_no_NAs-1.pdf)<!-- --> 
...
![](PA1_template_files/figure-latex/weekend_comparison-1.pdf)<!-- --> 
